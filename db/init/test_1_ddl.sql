...
-- -----------------------------------------------------
-- Schema dojo_api_test
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema dojo_api_test
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dojo_api_test` DEFAULT CHARACTER SET utf8mb4 ;
USE `dojo_api_test` ;

SET CHARSET utf8mb4;

-- -----------------------------------------------------
-- Table `dojo_api_test`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dojo_api_test`.`user` (
...
-- -----------------------------------------------------
-- Table `dojo_api_test`.`collection_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dojo_api_test`.`collection_item` (
...
-- -----------------------------------------------------
-- Table `dojo_api_test`.`user_collection_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dojo_api_test`.`user_collection_item` (
...
-- -----------------------------------------------------
-- Table `dojo_api_test`.`gacha_probability`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dojo_api_test`.`gacha_probability` (
  `collection_item_id` VARCHAR(128) NOT NULL COMMENT 'コレクションアイテムID',
